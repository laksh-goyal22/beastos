...
/// Standard 8x8 VGA font for basic ASCII.
/// Only characters 0x20 (space) to 0x7E (tilde) are implemented here to save space.
pub const FONT_8X8: [[u8; 8]; 95] = [
    [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], // 0x20 Space
    [0x18, 0x3C, 0x3C, 0x18, 0x18, 0x00, 0x18, 0x00], // 0x21 !
    [0x6C, 0x6C, 0x6C, 0x00, 0x00, 0x00, 0x00, 0x00], // 0x22 "
    [0x6C, 0x6C, 0xFE, 0x6C, 0xFE, 0x6C, 0x6C, 0x00], // 0x23 #
    [0x18, 0x7E, 0xC0, 0x7E, 0x06, 0x7E, 0x18, 0x00], // 0x24 $
    ...
    [0x3C, 0x66, 0x66, 0x6E, 0x76, 0x66, 0x3C, 0x00], // 0x30 0
    ...
    [0x3C, 0x66, 0x6E, 0x6E, 0x60, 0x66, 0x3C, 0x00], // 0x40 @
    ...
    [0x06, 0x06, 0x06, 0x06, 0x66, 0x66, 0x3C, 0x00], // 0x4A J
    ...
    [0x00, 0x00, 0x7A, 0x6B, 0x6B, 0x6B, 0x6B, 0x00], // 0x6D m
    ...
    [0x3A, 0x6E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], // 0x7E ~
];

pub fn get_char_bitmap(c: char) -> Option<&'static [u8; 8]> {
    let cp = c as usize;
    if cp >= 0x20 && cp <= 0x7E {
        Some(&FONT_8X8[cp - 0x20])
    } else {
        None
    }
}
